...
class MedicalRecordSchema(BaseSchema, UniqueIdMixin, TimestampMixin):
    __model__ = models.MedicalRecord
...
class EmployeeSchema(BaseSchema, UniqueIdMixin, TimestampMixin):
